...
} from '../../pages/ModelPage/ProviderConfigs'
import { ModelList } from '../../pages/ModelPage/ModelList'
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                {(activeProvider.modelSource === 'dynamic' || activeProvider.type === 'local') && (
                  <>
                    <Button variant="ghost" size="sm" onClick={handleSelectAll} disabled={syncing}>
                      {t('models.select_all')}
                    </Button>
                    <Button
                      variant="ghost"
                ...
                {activeProvider.modelSource === 'dynamic' &&
                  (activeProvider.apiKey ||
                    hasSubscriptionOAuth(activeProvider) ||
